...
\033[1;91m██║░░██║██║░╚███║██║░╚═╝░██║╚█████╔╝███████╗
\033[1;92m╚═╝░░╚═╝╚═╝░░╚══╝╚═╝░░░░░╚═╝░╚════╝░╚══════╝
\033[1;96m«-----------------\033[1;94mAwanMafia\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  SOMI 
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  ANMOL
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈ 
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
...
\033[1;96m«-----------------\033[1;91mAwanMafia\033[1;92m-----------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
B = '\033[1;94m'
...
def menu():
    ...
    print(logo)
    time.sleep(0.05)
    print("\033[1;42m\033[1;37m1   To return to this menu from any Tool   \033[1;0m")
    time.sleep(0.05)
    print("\033[1;41m2\033[1;37m       Stop Process Press CTRL + z        \033[1;0m")
    time.sleep(0.05)
    print("\033[1;93m3\033[1;37m         Type python2 Cloning.py          \033[1;0m")
    time.sleep(0.05)
    print("\033[1;91m[1]  FAST CLONING WITH SOMI HACK      ●")
    time.sleep(0.05)
    print("\033[1;92m[2]  Install Facebook login  Tool      ●")
    time.sleep(0.05)
    print("\033[1;91m[3]  Install SpiderMan       Tool      ●")
    time.sleep(0.05)
    print("\033[1;92m[4]  Install Kalilinux       Tool      ●")
    time.sleep(0.05)
    print("\033[1;91m[5]  Install BlackHat        Tool      ●")
    time.sleep(0.05)
    print("\033[1;92m[6]  Install RedMoonNew      Tool      ●")
    time.sleep(0.05)
    print("\033[1;91m[7]  Install love3Hack3r     Tool      ●")
    time.sleep(0.05)
    print("\033[1;91m[8]  Install Cobra           Tool      ●")
    time.sleep(0.05)
    print("\033[1;92m[9]  Install Dragon          Tool      ●")
    time.sleep(0.05)
    print("\033[1;91m[10] Install NetHunting      Tool      ●")
    time.sleep(0.05)
    print("\033[1;92m[11] Install Payload         Tool      ●")
    time.sleep(0.05)
    print("\033[1;91m[12] Install CamHacker       Tool      ●")
    time.sleep(0.05)
    print("\033[1;92m[13] Install Compiler        Tool      ●")
    time.sleep(0.05)
    print("\033[1;91m[14] Install Instagram Brut  Tool      ●")
    time.sleep(0.05)
    print("\033[1;94m[15] Tool Update                       ●")
    time.sleep(0.05)
    print("\033[1;91m[0]  EXIT")
    time.sleep(0.05)
    mafia()
def mafia():
	black = raw_input("\033[1;92m slect option>>>   ")
	if black =="":
		...
		os.system("cd Cloningx")
                love("\033[1;93mTool User Name\033[1;92m Awan\033[1;93m Password \033[1;92mMafia")
                time.sleep(6)
	        ...
	        os.system("ls")
                os.system("cd World")
		os.system("cd Somi awan")
                love("\033[1;93mTool User Name\033[1;92m Awan\033[1;93m Password \033[1;92mMafia")
                time.sleep(6)
                os.system("python2 Awanmafia.py")
	elif black =="3":
	        clear()
	        print(logo)
	        ...
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name Anmol Password Somi")
                time.sleep(5)
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/KaliIndia")
                print (logo)
		love("\033[1;96mCongratulations AwanMafia Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		love("\033[1;93mTool User Name Somi Password Anmol")
                time.sleep(5)
		...
		love("Now you can open this tool as usual")
		love("\033[1;93mTool User Name BlackHat Password Anmol")
                time.sleep(5)
	        ...
	        love("Now you can open this tool as usual")
                love("\033[1;93mTool User Name\033[1;92m RedMoonNew\033[1;93m Password \033[1;92mSomihacker")
                time.sleep(6)
		...
		time.sleep(5)
	        ...
	        os.system("rm -rf $HOME/Awan_Mafia")
	        os.system("cd $HOME && git clone https://github.com/lovehacker404/Awan_Mafia")
                print (logo)
	        love("\033[1;93mCongratulations Awan_Mafia Payload Tool Has Been Installed Successfully")
	        love("Now you can open this tool as usual")
                time.sleep(5)
                os.system("cd $HOME/Awan_Mafia && python3 Awan_Mafia.py")
	elif black =="12":
	        clear()
		print(logo)
		...
		os.system("rm -rf $HOME/Compile")
	        ...
	        love("\033[1;93mCongratulations  Tool Has Been Update Successfully")
	        love("Now you can open this tool as usual")
                love("Passwordlist No1 (wordlist.txt) No2 (AwanMafia.txt)")
                time.sleep(5)
